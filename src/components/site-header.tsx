      ...
      <div className="mx-auto flex min-h-16 max-w-7xl items-center justify-between gap-2 px-4 sm:gap-3 sm:px-5 lg:px-8">
        ...
        <div className="flex items-center gap-0.5 sm:gap-1">
          <div className="hidden items-center gap-0.5 sm:flex">
            <Button variant="ghost" size="icon" className="motion-button text-background hover:bg-background/10 hover:text-primary" onClick={onOpenSearch} aria-label="Open search"><Search /></Button>
          ...
          <Button variant="ghost" size="icon" className="motion-button text-background hover:bg-background/10 hover:text-primary" onClick={onToggleTheme} aria-label={darkMode ? 'Switch to light mode' : 'Switch to dark mode'}>{darkMode ? <Sun /> : <Moon />}</Button>
